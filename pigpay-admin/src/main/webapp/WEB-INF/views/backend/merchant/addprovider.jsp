		...
		<div class="wrap-content">
			<form id="form" method="post" class="form form-horizontal" action="${rootpath }admin/user/save">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="agentName" class="form-control"> <span
							class="help-block m-b-none"></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="qrcodeCountLimit" class="form-control"> <span
							class="help-block m-b-none"></span>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="acctCountLimit" class="form-control"> <span
							class="help-block m-b-none"></span>
					</div>
				</div>
